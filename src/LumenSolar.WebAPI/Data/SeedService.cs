...
namespace LumenSolar.WebAPI.Data
{
    ...
    {
        public static readonly List<DoadorUserMock> Doadores =
        [
            new DoadorUserMock
            {
    ...
    {
        public static readonly List<FamiliaUserMock> Familias =
        [
            new FamiliaUserMock
        {
            User = new IdentityUser
    ...
    public class DoadorDoacaoMock
    {
        public Doador Doador { get; set; }
        public List<Doacao> Doacoes { get; set; }
    }

    public class DoadorUserMock
    {
        public IdentityUser User { get; set; }
        public DoadorDoacaoMock Doador { get; set; }
    }

    public class FamiliaUserMock
    {
        public IdentityUser User { get; set; }
    ...
    public class SeedService
    {
        ...
        public async Task SeedAsync()
        {
            ...
            foreach (DoadorUserMock mock in MocksDoador.Doadores)
            {
            ...
            foreach (FamiliaUserMock mock in MocksFamilia.Familias)
            {
                IdentityUser user = mock.User;
                string senhaPadrao = "Senha123!";
